...
if localVersion ~= version then
    Rayfield:Notify({Title = "Hexer_hub",Content = "Atualização Necessária...",Duration = 6.5,Image = 4483362458,})
...
local Paragraph = homeTab:CreateParagraph({Title = "Hexer_hub", Content = "Welcome to Hexer_hub! "..Player.Name.." | Credits: Nydev and LeoLeoVip"})

local Label = homeTab:CreateLabel("Hexer_hub Discord", 10709797725, Color3.fromRGB(10, 10, 10), false)
